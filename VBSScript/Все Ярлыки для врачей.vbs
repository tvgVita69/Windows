...
SavePsw.Run "cmd.exe /c chcp 1251&&net use \\labserver /user:presnya\Администратор_ begin",0,true
SavePsw.Run "cmd.exe /c chcp 1251&&net use \\192.168.0.2 /user:presnya\Администратор_ begin",0,true
SavePsw.Run "cmd.exe /c chcp 1251&&net use \\win2kserv.moscow.onclinic.microsoft.com /user:presnya\Администратор_ begin",0,true
SavePsw.Run "cmd.exe /c chcp 1251&&net use \\192.168.0.100 /user:presnya\Администратор_ begin",0,true
SavePsw.Run "cmd.exe /c chcp 1251&&net use \\bicept.moscow.onclinic.microsoft.com /user:presnya\Администратор_ begin",0,true
SavePsw.Run "cmd.exe /c chcp 1251&&net use \\192.168.0.211 /user:presnya\Администратор_ begin",0,true
SavePsw.Run "cmd.exe /c chcp 1251&&net use \\bicepz.moscow.onclinic.microsoft.com /user:presnya\Администратор_ begin",0,true
SavePsw.Run "cmd.exe /c chcp 1251&&net use \\192.168.0.210 /user:presnya\Администратор_ begin",0,true
...
objSC.IconLocation = "\\192.168.1.100\netlogon\label\numbers.ico"
objSC.TargetPath = "\\192.168.0.211\Froda\On_Eib_P\Программы\spisok.hta"
objSC.WindowStyle = 1
objSC.WorkingDirectory = "\\192.168.0.211\Froda\On_Eib_P\Программы"
objSC.Save
Set objSC = Nothing
Set objWShell = Nothing
...
objSC.TargetPath = "\\192.168.0.211\Froda\On_Eib_P\Программы\Пресня.hta"
objSC.WindowStyle = 1
objSC.WorkingDirectory = "\\192.168.0.211\Froda\On_Eib_P\Программы"
objSC.Save
Set objSC = Nothing
